                ...
                <div class="flex flex-col gap-10">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div id="Arrived"
                            ...
                            <!-- Format the arrived date in the same way as expired date -->
                            <input id="datepicker-arrived" name="arrived_date" value="{{ old('arrived_date', \Carbon\Carbon::parse($medicine->m_da)->format('Y-m-d')) }}"  type="text"
                ...
                <div class="flex flex-col gap-10">
                    ...
                    <div class="flex flex-col">
                        ...
                        <div id="Expired"
                            ...
                            <!-- Use the same format for expired date -->
                            <input id="datepicker-expired" name="m_date_expired" value="{{ old('m_date_expired', \Carbon\Carbon::parse($medicine->m_date_expired)->format('Y-m-d')) }}"
